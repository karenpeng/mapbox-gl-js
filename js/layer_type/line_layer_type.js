...
module.exports = {
    ...
    build: function(features, builder) {
        ...
        function addFeature(feature) {
            ...
            var layoutProperties = builder.layoutProperties;
        ...
        function addLine(vertices, join, cap, miterLimit, roundLimit) {
            ...
            builder.makeRoomFor('line', len * 10);
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (currentJoin === 'miter') {
                    ...
                    addCurrentVertex(currentVertex, flip, distance, joinNormal, 0, 0, false);
                    ...
                    if (currentJoin === 'fakeround') {
                        ...
                        for (var m = 0; m < n; m++) {
                            ...
                            addPieSliceVertex(currentVertex, flip, distance, approxFractionalJoinNormal, lineTurnsLeft);
                        }

                        addPieSliceVertex(currentVertex, flip, distance, joinNormal, lineTurnsLeft);
                    ...
                    // Start next segment
                    if (nextVertex) {
                        addCurrentVertex(currentVertex, flip, distance, nextNormal, -offsetA, -offsetB, false);
                    }
                    ...
                    if (!startOfLine) {
                        ...
                        addCurrentVertex(currentVertex, flip, distance, prevNormal, 1, 1, true);
         ...
         * @private
         */
        function addCurrentVertex(currentVertex, flip, distance, normal, endLeft, endRight, round) {
            var tx = round ? 1 : 0;
            var extrude;

            extrude = normal.mult(flip);
            if (endLeft) extrude._sub(normal.perp()._mult(endLeft));
            e3 = builder.addLineVertex(currentVertex, extrude, tx, 0, distance);
            if (e1 >= 0 && e2 >= 0) {
                builder.addLineElement(e1, e2, e3);
            }
            e1 = e2;
            e2 = e3;
            ...
            e3 = builder.addLineVertex(currentVertex, extrude, tx, 1, distance);
            if (e1 >= 0 && e2 >= 0) {
                builder.addLineElement(e1, e2, e3);
            }
            e1 = e2;
         ...
         * @private
         */
        function addPieSliceVertex(currentVertex, flip, distance, extrude, lineTurnsLeft) {
            var ty = lineTurnsLeft ? 1 : 0;
            extrude = extrude.mult(flip * (lineTurnsLeft ? -1 : 1));

            e3 = builder.addLineVertex(currentVertex, extrude, 0, ty, distance);
